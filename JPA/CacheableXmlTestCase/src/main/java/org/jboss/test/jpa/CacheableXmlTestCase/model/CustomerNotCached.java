...
@Table(name = "CUSTOMER_NOT")
public class CustomerNotCached implements Serializable, ICustomer {
	...
	public CustomerNotCached() {

	}

	public CustomerNotCached(String name, Integer credit) {
		this.name = name;
